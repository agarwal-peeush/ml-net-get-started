...
namespace FirstMLAppML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\agarw\Desktop\Personal\Peeush Agarwal\Repositories\ml-net-get-started\FirstMLApp\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../FirstMLAppML.Model/MLModel.zip";
